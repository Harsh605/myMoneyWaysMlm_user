...
import { fetchTeamInfo } from '../../../../api/integrateConfig';
...
const ChatAppContain = () => {
  ...
  if (searchFromUserName !== '') {
    filteredData = data.filter(user => user.user.name.toLowerCase().includes(searchFromUserName.toLowerCase()));
  }
  ...
  const columns = [
    ...
    {
      name: "Sponser Wallet Address",
      selector: (row) => row.user.referBy,
      width: '300px'
    },
    {
      name: "Referral Income",
      selector: (row) => row.user.refferalIncome,
      width: '200px'
    },
    {
      name:"Level",
    ...
    {
      name: "Level Income",
      selector: (row) => row.user.levelIncome,
      width: '200px'
    },
    {
      name: "Package Upgrade Income",
      selector: (row) => row.user.packageIncome,
      width: '200px'
    },
    {
      name: "Slot Income",
      selector: (row) => row.user.slotIncome,
      width: '200px'
    },
    {
      name: "Total Income",
      selector: (row) => (row.user.slotIncome+row.user.packageIncome+row.user.levelIncome+row.user.refferalIncome),
      width: '200px'
    },{
      name:"Date & Time",
      selector: (row) => new Date(row.user.createdAt).toLocaleString(),
      width: '200px'
    }
  ];
