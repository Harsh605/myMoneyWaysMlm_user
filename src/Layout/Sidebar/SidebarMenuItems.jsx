...
import UserHeader from "../Header/RightHeader/UserHeader";
import Logout from "../Header/RightHeader/Logout";
...
const SidebarMenuItems = ({ setMainMenu, sidebartoogle, setNavActive, activeClass }) => {
  ...
  return (
    <>
      ...
      <Logout/>
      {/* <p style={{color:"#ffffff",padding:"12px 20px"}} className={`sidebar-link sidebar-title link-nav }`}> <i className="fas fa-sign-out-alt" aria-hidden="true"></i>Log Out</p> */}
